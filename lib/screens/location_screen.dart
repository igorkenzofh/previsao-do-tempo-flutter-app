...
class LocationScreen extends StatefulWidget {
  //TODO 13: Passando dados da loading screen para a location screen, assim ele pega a locatioondata assim que inicia a locations creen
  ...
  void updateUI(dynamic weatherData) {
    setState(() {
      if (weatherData == null) {
        temperature = 0;
        weatherIcon = 'Error';
        weatherText = 'Unable to fetch data';
        cityName = '';
